...
class Cycling extends Workout{
    ...
    constructor(coords, distance, duration, elevationalGain){
    super(coords, distance, duration);
        this.elevationalGain = elevationalGain;
        this._setDescription();
}
...
class App{
    ...
    _hideForm(){
        inputCadence.value = inputDuration.value = inputCadence.value = inputElevation.value = '';
         ...
         <li class="workout workout--${workout.name}" data-id="${workout.id}">
          ...
          <div class="workout__details">
            ...
            if(workout.type === 'cycling'){
                ...
                <div class="workout__details">
                    <span class="workout__icon">⛰</span>
                    <span class="workout__value">${workout.elevationalGain}</span>
